...
import 'package:pull_to_***REMOVED***/pull_to_***REMOVED***.dart';
...
class _AppPaginationWidgetState extends State<AppPaginationWidget> {
  final RefreshController _***REMOVED***Controller =
  ...
  Future<void> _onLoading() async {
    ...
    if (await widget.onLoading(_page)) {
      ...
      _***REMOVED***Controller.loadComplete();
    } else {
      debugPrint("loading Another Page No DATa");

      _***REMOVED***Controller.loadNoData();
    }
  }

  Future<void> _onRefresh() async {
    if (await widget.onRefresh!()) {
      _***REMOVED***Controller.***REMOVED***Completed();
    } else {
      _***REMOVED***Controller.***REMOVED***Failed();
    }
  }
