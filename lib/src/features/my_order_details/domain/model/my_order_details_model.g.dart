...
_MyOrderDetailsModel _$MyOrderDetailsModelFromJson(Map<String, dynamic> json) =>
    _MyOrderDetailsModel(
      ...
      fareDetails: FareDetails.fromJson(
        json['fare_details'] as Map<String, dynamic>,
      ),
...
Map<String, dynamic> _$MyOrderDetailsModelToJson(
  _MyOrderDetailsModel instance,
) => <String, dynamic>{
